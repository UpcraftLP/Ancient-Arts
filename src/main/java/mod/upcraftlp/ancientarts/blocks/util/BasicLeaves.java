...
public abstract class BasicLeaves extends Block implements IShearable {
	...
	public List<ItemStack> onSheared(ItemStack item, IBlockAccess world, BlockPos pos, int fortune) {
		...
		if(RANDOM.nextInt(this.getSaplingChance()) == 0 && this.getSapling() != null && !this.getSapling().isEmpty()) drops.add(this.getSapling());
		return drops;
	}
	
	@Nonnull
	public abstract ItemStack getSapling();
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return this.getSapling().getItem() != null ? this.getSapling().getItem() : Items.AIR;
	}
	...
	public abstract int getSaplingChance();
	
	@Override
	public int quantityDropped(Random random) {
		return random.nextInt(this.getSaplingChance()) == 0 ? 1 : 0;
	}
